...
protected:
    ...
    */
    ...
    THnSparseD *_exp_data_5d[29][5][3];
    THnSparseD *_sim_data_5d[29][5][3];
    THnSparseD *_empty_5d[29][5][3];
    THnSparseD *_thrown_5d[29][5][3];
    THnSparseD *_thrown_no_rad_5d[29][5][3];
    THnSparseD *_sim_holes_5d[29][5][3];
    THnSparseD *_sim_holes_tmp_5d[29][5][3];
    THnSparseD *_N_holes_5d[29][5][3];
    THnSparseD *_acceptance_5d[29][5][3];
    THnSparseD *_N_5d[29][5][3];
	...
	TH2D* _rad_corr[3];//Radiative Corrections
	double_2d _rad_corr_array[3];
	double _rad_corr_mu[3];//integral thrown over integral thrown no-radiative effects
	double_2d _rad_error[3];//Statistical Error for radiative corrections
	...
	TH1D_3d_star _mm_difference_hist;//{w,q2,X,tree} X->{MM1,MM2,theta,alpha,phi}
