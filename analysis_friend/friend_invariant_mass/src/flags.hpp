...
static std::string _sim_file_pim_ = "-sim_pim=";
static std::string _sim_file_pro_ = "-sim_pro=";
static std::string _sim_file_pip_ = "-sim_pip=";
static std::string _exp_file_pim_ = "-exp_pim=";
static std::string _exp_file_pro_ = "-exp_pro=";
static std::string _exp_file_pip_ = "-exp_pip=";
static std::string _empty_file_pim_ = "-empty_pim=";
static std::string _empty_file_pro_ = "-empty_pro=";
static std::string _empty_file_pip_ = "-empty_pip=";
static std::string _sim_no_rad_file_pim_ = "-no_rad_pim=";
static std::string _sim_no_rad_file_pro_ = "-no_rad_pro=";
static std::string _sim_no_rad_file_pip_ = "-no_rad_pip=";
...
private:
	...
	std::string _sim_pim_loc = "";
	std::string _sim_pro_loc = "";
	std::string _sim_pip_loc = "";
	std::string _exp_pim_loc = "";
	std::string _exp_pro_loc = "";
	std::string _exp_pip_loc = "";
	std::string _empty_pim_loc = "";
	std::string _empty_pro_loc = "";
	std::string _empty_pip_loc = "";
	std::string _sim_no_rad_pim_loc = "";
	std::string _sim_no_rad_pro_loc = "";
	std::string _sim_no_rad_pip_loc = "";
...
public:
	...
	//File Names
	std::string Sim_File(std::string var_set_);
	std::string Exp_File(std::string var_set_);
	std::string Empty_File(std::string var_set_);
	std::string No_Rad_File(std::string var_set_);
	std::string Sim_File();
	std::string Exp_File();
