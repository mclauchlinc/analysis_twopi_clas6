...
static const  char* _hcuts_[] = {_none_,_sanity_, _fid_cut_, _delta_cut_,_sc_eff_cut_,_id_cut_,_geo_sc_cut_,_geo_ec_cut_,_kin_eff_cut_,_pid_,_event_};//Be sure to add statements for flags if modified
