...
static const  int _other_e1f_[] = {37658, 38091, 38131, 38339, 38340, 38352, 38424, 38425, 38426, 38427, 38429, 38439, 38478, 38658, 38659, 38660, 38661, 38662, 38663, 38664, 38665, 38666, 38667, 38668}; //Delayed helicity reporting, Reversed Torus field, ambiguous helicity, not in gold run list, CC problem, DC problem, DAQ test
...
static const  char * _geo_cc_cut_ = "geo_cc";
static const  char * _geo_sc_cut_ = "geo_sc";
static const  char * _geo_ec_cut_ = "geo_ec";
static const  char * _kin_eff_cut_ = "kin_eff";
...
static const  char* _ecuts_[] = {_none_,_sanity_, _fid_cut_, _sf_cut_, _cc_cut_, _ec_cut_, _sc_eff_cut_, _vertex_cut_,_id_cut_,_geo_cc_cut_,_geo_sc_cut_,_geo_ec_cut_,_kin_eff_cut_,_pid_,_event_};//Be sure to add statements for flags if modified
static const  char* _hcuts_[] = {_none_,_sanity_, _fid_cut_, _delta_cut_,_sc_eff_cut_,_id_cut_,_geo_sc_cut_,_kin_eff_cut_,_pid_,_event_};//Be sure to add statements for flags if modified
...
static const  char* _cc_sides_[] = {_right_,_coinc_,_left_};
...
static const  char * CC_det_side[] = {"Right","Coince","Left","All"};//Changed later
...
static const  char * _dc_ = "dc";
static const  char * _cc_ = "cc";
static const  char * _sc_ = "sc";
static const  char * _ec_ = "ec";
static const  char * detectors[] = {_dc_,_cc_,_sc_,_ec_};
